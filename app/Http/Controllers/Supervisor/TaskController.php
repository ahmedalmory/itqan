...
class TaskController extends Controller
{
    ...
    /**
     * Display a listing of the supervisor's assigned tasks.
     */
    public function index(Request $request)
    {
        ...
        return view('supervisor.tasks.index', compact('assignments'));
    }
    ...
    public function today(Request $request)
    {
        ...
        return view('supervisor.tasks.today', compact('assignments', 'date'));
    }
    ...
    public function show(TaskAssignment $assignment)
    {
        ...
        return view('supervisor.tasks.show', compact('assignment'));
    }
    ...
    /**
     * Get tasks statistics for supervisor.
     */
