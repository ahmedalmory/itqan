    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('department-admin.tasks.store') }}" method="POST">
                        @csrf
                                ...
                                <div id="userAssignment" class="mb-3" style="display: none;">
                                    ...
                                    <select class="form-select @error('assigned_to_user_id') is-invalid @enderror" 
                                        ...
                                        @foreach($teachers as $teacher)
                                            <option value="{{ $teacher->id }}" {{ old('assigned_to_user_id') == $teacher->id ? 'selected' : '' }}>
                                                {{ $teacher->name }} ({{ t('Teacher') }})
                                            </option>
                                        @endforeach
                                        @foreach($supervisors as $supervisor)
                                            <option value="{{ $supervisor->id }}" {{ old('assigned_to_user_id') == $supervisor->id ? 'selected' : '' }}>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('department-admin.tasks.index') }}" class="btn btn-secondary">
