...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">{{ t('Edit Department') }}</h1>
            ...
            <form action="{{ route('admin.departments.update', $department) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('student_gender') is-invalid @enderror" id="student_gender" name="student_gender" required>
                        ...
                        <option value="male" {{ old('student_gender', $department->student_gender) == 'male' ? 'selected' : '' }}>{{ t('Male') }}</option>
                        <option value="female" {{ old('student_gender', $department->student_gender) == 'female' ? 'selected' : '' }}>{{ t('Female') }}</option>
                        <option value="mixed" {{ old('student_gender', $department->student_gender) == 'mixed' ? 'selected' : '' }}>{{ t('Mixed') }}</option>
                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.01" min="0" class="form-control @error('monthly_fees') is-invalid @enderror" id="monthly_fees" name="monthly_fees" value="{{ old('monthly_fees', $department->monthly_fees) }}">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.01" min="0" class="form-control @error('quarterly_fees') is-invalid @enderror" id="quarterly_fees" name="quarterly_fees" value="{{ old('quarterly_fees', $department->quarterly_fees) }}">
                                        <span class="input-group-text">{{ t('EGP') }}</span>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.01" min="0" class="form-control @error('biannual_fees') is-invalid @enderror" id="biannual_fees" name="biannual_fees" value="{{ old('biannual_fees', $department->biannual_fees) }}">
                                        <span class="input-group-text">{{ t('EGP') }}</span>
                                    </div>
                                    @error('biannual_fees')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="0.01" min="0" class="form-control @error('annual_fees') is-invalid @enderror" id="annual_fees" name="annual_fees" value="{{ old('annual_fees', $department->annual_fees) }}">
                                        <span class="input-group-text">{{ t('EGP') }}</span>
                                    </div>
                                    @error('annual_fees')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="work_days[]" value="monday" id="monday" 
                                               {{ in_array('monday', old('work_days', [])) || old('work_days') === null && $department->work_monday ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="work_days[]" value="tuesday" id="tuesday" 
                                               {{ in_array('tuesday', old('work_days', [])) || old('work_days') === null && $department->work_tuesday ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="work_days[]" value="wednesday" id="wednesday" 
                                               {{ in_array('wednesday', old('work_days', [])) || old('work_days') === null && $department->work_wednesday ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="work_days[]" value="thursday" id="thursday" 
                                               {{ in_array('thursday', old('work_days', [])) || old('work_days') === null && $department->work_thursday ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="work_days[]" value="friday" id="friday" 
                                               {{ in_array('friday', old('work_days', [])) || old('work_days') === null && $department->work_friday ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="work_days[]" value="saturday" id="saturday" 
                                               {{ in_array('saturday', old('work_days', [])) || old('work_days') === null && $department->work_saturday ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="work_days[]" value="sunday" id="sunday" 
                                               {{ in_array('sunday', old('work_days', [])) || old('work_days') === null && $department->work_sunday ? 'checked' : '' }}>
                ...
                <div class="mb-3">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="registration_open" name="registration_open" value="1" 
                               {{ old('registration_open', $department->registration_open) ? 'checked' : '' }}>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save"></i> {{ t('Update Department') }}
                    </button>
                </div>
            </form>
        </div>
