        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">{{ t('Add New Translation') }}</h5>
                </div>
                    ...
                    <form action="{{ route('admin.translations.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('translation_key') is-invalid @enderror" 
                                   id="translation_key" name="translation_key" value="{{ old('translation_key') }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('translation_value') is-invalid @enderror" 
                                      id="translation_value" name="translation_value" rows="4" required>{{ old('translation_value') }}</textarea>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-1"></i> {{ t('Save Translation') }}
                            </button>
                        </div>
                    </form>
                </div>
