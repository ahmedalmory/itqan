...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            @endif
            <a href="{{ route('teacher.points.leaderboard') }}" class="btn btn-outline-primary">
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-light py-3">
            <form method="GET" action="{{ route('teacher.points.index') }}" class="row g-3 align-items-center">
                <div class="col-md-4">
