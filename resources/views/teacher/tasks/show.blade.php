...
<div class="container my-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <a href="{{ route('teacher.tasks.index') }}" class="btn btn-outline-secondary btn-sm mb-2">
    ...
    @else
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('teacher.tasks.uncomplete', $assignment) }}" method="POST" class="mt-3">
                    @csrf
