...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item"><a href="{{ route('supervisor.rewards.index') }}">{{ t('Rewards') }}</a></li>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('supervisor.rewards.index') }}" class="btn btn-outline-primary w-100">
